...
const Article = () => {
  return (
        <blockquote><font face="Times New Roman"><div>
          <section>
            <header>
            <h1>The Statue of Liberty's torch heads to new museum</h1>
        <i>by Kate Farley</i> <cite><ins><a href = "mailto: kate.farley@nytimes.com">(kate.farley@nytimes.com)</a></ins></cite>
      <br/><time>November 22, 2018</time>
          </header>
      ...
      <p>Not only is the Statue of Liberty the symbol of New York City, she is also a <strong>UNESCO World Heritage</strong> site under the designation of <i>_Outstanding Universal Value_.</i></p>
      ...
      <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* Height of the Statue from her heel to the top of her head is 111 feet, 6 inches

      <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* The Statue has a <strong>35-foot</strong> waistline

      <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* Total weight of the Statue of Liberty is <strong>225 tons (or 450,000 pounds)</strong>
          </footer></section>
    </div></font></blockquote>
